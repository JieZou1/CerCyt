...
import cercyt.nucleus_mrcnn as nucleus_mrcnn

DATASET_DIR = "Z:\\datasets\\data-science-bowl-2018\\"


# Use configuration from nucleus_mrcnn.py, but override
# image resizing so we see the real sizes here
class NoResizeConfig(nucleus_mrcnn.NucleusConfig):
...
dataset = nucleus_mrcnn.NucleusDataset()
...
#          of validation images see nucleus_mrcnn.py
...
class RandomCropConfig(nucleus_mrcnn.NucleusConfig):
