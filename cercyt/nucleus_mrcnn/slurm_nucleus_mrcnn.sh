#!/bin/bash
#SBATCH --workdir=/slurm_storage/jzou/programs/CerCyt/
#SBATCH --output=/slurm_storage/jzou/programs/CerCyt/slurm_%j.out
#SBATCH --error=/slurm_storage/jzou/programs/CerCyt/slurm_%j.error
