...
#SBATCH --workdir=/slurm_storage/jzou/CerCyt/cercyt/nucleus_mrcnn/slurm/
#SBATCH --output=/slurm_storage/jzou/CerCyt/cercyt/nucleus_mrcnn/slurm/slurm_%j.out
#SBATCH --error=/slurm_storage/jzou/CerCyt/cerctt/nucleus_mrcnn/slurm/slurm_%j.error
