...
# env
which python
python /slurm_storage/jzou/programs/CerCyt/cercyt/nucleus_mrcnn.py train --weights coco --dataset /slurm_storage/jzou/datasets/data-science-bowl-2018 --subset stage1_train
